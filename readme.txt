...
* Can be used under 4 different languages(English, Frech, Spanish, Germen)
...
1. Go to the admin menu 'Plugins' -> 'Install' and search for 'twitter-feeder.zip'
...
1. Unzip the folder `twitter-feeder.zip` and move files to the `/wp-content/plugins/` directory.
...
Showtweets Plugin is released under the GNU General Public License V3.For more information please read<a href="http://www.gnu.org/copyleft/gpl.html">http://www.gnu.org/copyleft/gpl.html</a>
